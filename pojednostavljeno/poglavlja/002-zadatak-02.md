...
Slika 2.1 prikazuje fazorske dijagrame oba režima ovog zadatka: levo pod a) prvi režim, desno pod b) drugi režim; detaljno čitanje dato je odmah ispod slike.
...
> **Kako čitati sliku 2.1:** Oba dijagrama crtana su po fazi: dužine fazora napona su naponi u voltima, a strelice struja $\underline{I}_1$ i $\underline{I}_2$ ucrtane su radi pravca (struja i napon nisu u istoj razmeri); rotacija fazora je suprotna kazaljci na satu. **Dijagram a) — prvi režim:** struja $\underline{I}_1$ leži na istom pravcu kao vertikalni fazni napon $\underline{U}_f$, jer je $\varphi_1 = 0$ (označeno lukom pri korenu fazora); pad napona $jX_s\underline{I}_1$ je kratka horizontalna strelica ulevo na vrhu $\underline{U}_f$ — upravan na struju, dužine $X_s I_1 = 75{,}97\ \mathrm{V}$ naspram $U_f = 219{,}4\ \mathrm{V}$; hipotenuza od korena do vrha tog lanca je $\underline{E}_1$, sa $E_1 = 232{,}2\ \mathrm{V}$ — čista Pitagorina teorema iz Koraka 4. **Dijagram b) — drugi režim:** struja $\underline{I}_2$ zaklapa ugao $\varphi_2 = 60^\circ$ sa $\underline{U}_f$ i nacrtana je desno od napona — struja **kasni** za naponom (nadpobuđen generator daje mreži i induktivnu reaktivnu snagu); pad napona $jX_s\underline{I}_2$ sada je dvostruko duži ($151{,}93\ \mathrm{V}$) i opet upravan na $\underline{I}_2$, pa je hipotenuza $\underline{E}_2$ znatno duža i jače zakrenuta: $E_2 = 359{,}1\ \mathrm{V}$. Isprekidane linije sa kotama pokazuju razlaganje napona na pravac struje i upravno na njega: $U_f\cos\varphi_2 = 109{,}7\ \mathrm{V}$ (duža kota, u pravcu struje) i $U_f\sin\varphi_2 = 190{,}0\ \mathrm{V}$ (gornja kota, upravno na struju) — upravo veličine koje ulaze u opštu formulu za $E_2$ u Koraku 7. **Šta treba da zaključiš:** pri istoj aktivnoj snazi udvostručenje struje "zarotiralo" je struju za $60^\circ$ i isteglo $\underline{E}_2$ daleko preko $\underline{U}_f$ — zato pobuda mora porasti sa $7$ na $10{,}83\ \mathrm{A}$.
