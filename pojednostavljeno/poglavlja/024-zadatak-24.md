...
Na slici 24.1 (odmah ispod) oba sloja su nacrtana na istom dijagramu. Čitaj je ovako: iz zajedničke početne tačke (dole) polaze fazor napona $\underline{U}$ (vertikalno naviše) i fazor struje $\underline{I}$, koji **kasni** za naponom za ugao $\varphi$ (nagnut udesno). Donji desni trougao je „potrošački sloj“: uz pravac struje ide $R_{\mathrm{opt}}\underline{I}$ (pad na otporniku je u fazi sa strujom), pa se na njega pod pravim uglom nadovezuje $\mathrm{j}X_{\mathrm{opt}}\underline{I}$ (pad na kalemu prednjači struji $90^\circ$) i njihov zbir se tačno „zatvara“ u vrh fazora $\underline{U}$. Gornji deo je „generatorski sloj“: na vrh fazora $\underline{U}$ nadovezuje se isprekidani fazor $\mathrm{j}X_{\mathrm{s}}\underline{I}$ (opet pod pravim uglom na struju) i stiže u vrh fazora $\underline{E}_0$, koji prednjači naponu za **ugao snage** $\delta$. Ugao $\varphi$ ucrtan pri vrhu dijagrama (uz tačkastu pomoćnu liniju) isti je onaj $\varphi$ od dole: pošto je $\mathrm{j}X_{\mathrm{s}}\underline{I}$ uvek normalan na $\underline{I}$, on sa vertikalom/horizontalom zaklapa iste uglove kao struja sa naponom — to je samo geometrijska „kopija“ ugla, zgodna pri izvođenju jednačina. Dijagram je principski (nije crtan u razmeri).
